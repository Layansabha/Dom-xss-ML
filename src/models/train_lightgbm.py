...
# تدريب على 80%
final_model = LGBMClassifier(**grid.best_params_, class_weight="balanced", random_state=random_state, n_jobs=threads)
...
# ----------------------
# حفظ الموديل
joblib.dump(final_model, "lightgbm_best_model_final.pkl")
...
with open("top_features_final.txt", "w", encoding="utf-8") as f:
...
print("📈 ROC curve saved as roc_curve_test.png")
